...
cases! {
    ...
    a_definition_that_is_not_a_function: ["--emit", "safety-ir"],
    a_function_the_ir_cannot_hold: ["--emit", "safety-ir"],
    a_declaration_is_not_a_body: ["--emit", "ast"],
    a_failed_parse_reports_no_names: ["--emit", "ast"],
    a_lexical_error_leaves_no_ir: ["--emit", "safety-ir"],
    a_parse_error_leaves_no_ir: ["--emit", "safety-ir"],
    ...
    call: ["--emit", "ast"],
    edges_of_a_branch_and_a_loop: ["--emit", "safety-ir"],
    every_shape_the_artifact_spells: ["--emit", "safety-ir"],
